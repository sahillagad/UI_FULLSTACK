...
// By Default JavaScript Is asyncronous Progarming

const promiseHandlerVarible = new Promise((resolve, reject) => {
  var data = [
    {
      userId: 1,
      id: 1,
  ...
  if (data) {
    ...
    reject("Please Provide Correct URi");
  }
});

promiseHandlerVarible
  .then((result) => {
    console.log(result);
  })
  .catch((error) => {
